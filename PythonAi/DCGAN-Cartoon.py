...
def train(netG, netD, dataloader):
    ...
    optimizerG = torch.optim.Adam(netG.parameters(), lr=Lr, betas=(Betal, 0.999))
    optimizerD = torch.optim.Adam(netD.parameters(), lr=Lr, betas=(Betal, 0.999))
    ...
    for epoch in range(1, Epoch+1):
        for i, (imgs,_) in enumerate(dataloader):
            ...
            if i % 50 == 0:
                ...
                vutils.save_image(fake.data, '%s/fake_samples_epoch_%03d.png' %(OutPath, epoch),normalize = True)
